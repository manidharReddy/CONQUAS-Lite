...
@interface BCAViewController() <NSXMLParserDelegate>
@end
...
-(IBAction)btnSearchSubmitClicked:(id)sender {
    NSString *searchKeywords = txtKeywords.text;
    searchKeywords = [searchKeywords stringByReplacingOccurrencesOfString:@" " withString:@"%20"];
    [[UIApplication sharedApplication]openURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://www.google.com/cse?cx=008333683202955833228%%3Ai2mutbii3eg&ie=UTF-8&siteurl=www.google.com%%2Fcse%%2Fhome%%3Fcx%%3D008333683202955833228%%3Ai2mutbii3eg&ref=www.google.com%%2Fcse%%2Fmanage%%2Fall&ss=240j44288j3&q=%@#gsc.tab=0&gsc.q=%@&gsc.page=1", searchKeywords, searchKeywords]]];
}
...
-(IBAction)updateGGBAScore:(id)sender {
    /*int intGreen1, intGreen2, intGreen3, intGreen4, intGreen5, intGreen6, intGreen7, intGreen8, intGreen9, intGreen10, intGreen11, intGreen12, intGreen13, intGreen14, intGreen15, intGreen16, intGreen17, intGreen18, intGreen19, intGreen20, intGreen21, intGreen22, intGreen23;
    int intGracious1, intGracious2, intGracious3, intGracious4, intGracious5, intGracious6, intGracious7, intGracious8, intGracious9, intGracious10, intGracious11, intGracious12, intGracious13, intGracious14, intGracious15, intGracious16, intGracious17, intGracious18, intGracious19, intGracious20, intGracious21, intGracious22, intGracious23, intGracious24, intGracious25, intGracious26, intGracious27, intGracious28, intGracious29, intGracious30, intGracious31, intGracious32, intGracious33;
    int intInnovation1;
    int intBonus1;
    */
...
-(IBAction)btnGGBAButtonsClicked:(id)sender {
    ...
    [svGreen setContentSize:CGSizeMake(280,1350)];
    [svGracious setScrollEnabled:YES];
    [svGracious setContentSize:CGSizeMake(280,1950)];
    [svInnovation setScrollEnabled:YES];
    [svInnovation setContentSize:CGSizeMake(280,400)];
}
